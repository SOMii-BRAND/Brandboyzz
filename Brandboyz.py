...
\033[1;96mThe Credit For This Code Goes To Somi Brand
...
\033[1;96mBlacklist Life gun mari wife Tour touch Sky
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;91m[1]\x1b[1;91mSTART CLONING PRESS 1( \033[1;95m NEW UPDATE )"
    time.sleep(0.05)
    print "\033[1;95m[2]\x1b[1;97mUPDATE (9.0)"
    time.sleep(0.05)
